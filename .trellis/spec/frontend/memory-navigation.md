...
- Buffered/compressed rendering geometry, scroll mapping, and the compressed anchor invariant are owned by the dedicated [Virtual Scroll](./virtual-scroll.md) spec.
