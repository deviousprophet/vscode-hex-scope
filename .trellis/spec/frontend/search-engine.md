...
Applies to `core/search.ts` (deep module) and the webview glue `src/webview/search/searchEngine.ts`. The search bar UI unit is owned by [SearchBar Component Code-Spec](./search-bar-component.md); selection/inspector/copy contracts by [Selection, Inspector, and Byte Tools Code-Spec](./search-inspect-copy.md).
