...
src/webview/diff/diffGrid.ts          mount/reset, setDiffData, view mode, mirrored selection, copy, swap, search matches, scrollToDiff, loading-card swap, coalesced scroll renders, per-frame driver poll, follower transform/reconcile
