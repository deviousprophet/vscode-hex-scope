...
| Edit | Click **Edit** to patch bytes — click any byte and type two hex characters directly for fast patching, or right-click for batch fill; **Save** writes changes and recomputes checksums |
